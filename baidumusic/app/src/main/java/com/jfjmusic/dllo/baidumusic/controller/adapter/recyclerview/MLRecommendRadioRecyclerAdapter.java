 ...
 * 乐库-->推荐-->乐播节目----的recyclerview的Adapter
 */
public class MLRecommendRadioRecyclerAdapter extends RecyclerView.Adapter<MLRecommendRadioRecyclerAdapter.ViewHolder> {

    private Context context;
    private ViewHolder viewHolder;
    private List<MLRecommendBean.ResultBean.RadioBean.RadioResultBean> datas;
    ...
    public MLRecommendRadioRecyclerAdapter(Context context) {
        this.context = context;
    }

    public void setDatas(List<MLRecommendBean.ResultBean.RadioBean.RadioResultBean> datas) {
        this.datas = datas;
