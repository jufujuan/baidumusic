 ...
 * 我的-->本地音乐-----的listView的适配器
 */
public class MiLocalSongListViewAdapter extends BaseAdapter{
    private Context context;
    private List<LocalMusicBean> datas;

    public MiLocalSongListViewAdapter(Context context) {
        this.context = context;
    }

    public void setDatas(List<LocalMusicBean> datas) {
        this.datas = datas;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView= LayoutInflater.from(context).inflate(R.layout.item_fragment_mi_local_song,parent,false);
