 ...
 * 乐库-->推荐——>专栏----的recyclerview的Adapter
 */
public class MLRecommendMod7RecyclerAdapter extends RecyclerView.Adapter<MLRecommendMod7RecyclerAdapter.ViewHolder> {

    private Context context;
    private ViewHolder viewHolder;
    private List<MLRecommendBean.ResultBean.Mod7Bean.Mod7ResultBean> datas;
    ...
    public MLRecommendMod7RecyclerAdapter(Context context) {
        this.context = context;
    }

    public void setDatas(List<MLRecommendBean.ResultBean.Mod7Bean.Mod7ResultBean> datas) {
        this.datas = datas;
