 ...
 * 乐库-->推荐-->原创音乐----的recyclerview的Adapter
 */
public class MLRecommendMix9RecyclerAdapter extends RecyclerView.Adapter<MLRecommendMix9RecyclerAdapter.ViewHolder> {

    private Context context;
    private ViewHolder viewHolder;
    private List<MLRecommendBean.ResultBean.Mix9Bean.Mix9ResultBean> datas;
    ...
    public MLRecommendMix9RecyclerAdapter(Context context) {
        this.context = context;
    }

    public void setDatas(List<MLRecommendBean.ResultBean.Mix9Bean.Mix9ResultBean> datas) {
        this.datas = datas;
