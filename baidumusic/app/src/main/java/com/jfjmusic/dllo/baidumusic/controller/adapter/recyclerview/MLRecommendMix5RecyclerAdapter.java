 ...
 * 乐库-->推荐-->最热MV----的recyclerview的Adapter
 */
public class MLRecommendMix5RecyclerAdapter extends RecyclerView.Adapter<MLRecommendMix5RecyclerAdapter.ViewHolder> {

    private Context context;
    private ViewHolder viewHolder;
    private List<MLRecommendBean.ResultBean.Mix5Bean.Mix5ResultBean> datas;
    ...
    public MLRecommendMix5RecyclerAdapter(Context context) {
        this.context = context;
    }

    public void setDatas(List<MLRecommendBean.ResultBean.Mix5Bean.Mix5ResultBean> datas) {
        this.datas = datas;
